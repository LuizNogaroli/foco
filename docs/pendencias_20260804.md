# Lista de Pendências — 04/08/2026
...
- [ ] **Confirmar em tela o novo nome "Conformidade Prévia":**
  - Acessar o kanban e verificar se um processo neste status exibe "Conformidade Prévia".
  - Verificar a Aba 7 ao abrir um processo neste status.
